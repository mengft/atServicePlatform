import * as FinanceCProvidersInformationServices from '../../services/FinanceServiceProviders/ShipperFinCustomer'
...
export default {
  ...
  effects: {
    *fetch( { payload: { current } }, {call, put}){
      const data = yield call(FinanceCProvidersInformationServices.fetchInformation, { current });
