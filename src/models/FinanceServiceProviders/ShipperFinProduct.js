import * as FinanceProvidersInformationServices from '../../services/FinanceServiceProviders/ShipperFinProduct'
...
export default {
  ...
  effects: {
    *fetch( { payload: { current,car_type,province_id,city_id,service_company,isTraffic } }, {call, put}){
      const data = yield call(FinanceProvidersInformationServices.fetchInformation, { current:current,car_type:car_type,province_id:province_id,city_id:city_id,service_company:service_company });
