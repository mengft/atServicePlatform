import * as TrafficProvidersInformationServices from '../../services/TrafficServiceProviders/TrafficCustomer'
...
export default {
  ...
  effects: {
    *fetch( { payload: { current } }, {call, put}){
      const data = yield call(TrafficProvidersInformationServices.fetchTrafficInformation, { current });
