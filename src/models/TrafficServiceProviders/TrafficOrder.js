import * as TrafficProvidersInformationServices from '../../services/TrafficServiceProviders/TrafficOrder'
...
export default {
  ...
  effects: {
    *fetch( { payload: { current,car_type,province_id,city_id,status } }, {call, put}){
      const data = yield call(TrafficProvidersInformationServices.fetchTrafficInformation, { current:current,car_type:car_type,province_id:province_id,city_id:city_id,status:status });
